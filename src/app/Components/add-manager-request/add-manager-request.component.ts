...
@Component({
  selector: 'app-add-manager-request',
  templateUrl: './add-manager-request.component.html',
  styleUrls: ['./add-manager-request.component.css']
})
export class AddManagerRequestComponent implements OnInit {
