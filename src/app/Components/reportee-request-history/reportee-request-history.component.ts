...
@Component({
  selector: 'app-reportee-request-history',
  templateUrl: './reportee-request-history.component.html',
  styleUrls: ['./reportee-request-history.component.css']
})
export class ReporteeRequestHistoryComponent implements OnInit {
  ...
  ngOnInit(): void {
        ...
        this.requestService.GetRequestByStatusAndManagerID(this.userId,1).subscribe(res=>{
