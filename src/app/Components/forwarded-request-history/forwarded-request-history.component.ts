...
@Component({
  selector: 'app-forwarded-request-history',
  templateUrl: './forwarded-request-history.component.html',
  styleUrls: ['./forwarded-request-history.component.css']
})
export class ForwardedRequestHistoryComponent implements OnInit {
  ...
  ngOnInit(): void {
        ...
        this.requestService.GetForwadedRequests(this.userId,2).subscribe(res=>{
